...
{
    [CustomAuthorize(Roles = "SuperAdmin,AIPAdmin,ChartsOnly")]
    public class ProjectProfileController : Controller
    {
        ...
        {
            return View(db.vw_ProjectProfile.ToList());
        }

        // GET: ProjectProfile/Details/5
        public ActionResult Details(int? id)
        {
            ...
            vw_ProjectProfile vw_ProjectProfile = db.vw_ProjectProfile.Find(id);
            if (vw_ProjectProfile == null)
            {
                return HttpNotFound();
            }
            return View(vw_ProjectProfile);
        }
