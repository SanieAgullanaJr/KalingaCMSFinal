...
{
    public class AbsencesTardinessDetailsPerCutoffDateController : Controller
    {
        ...
        public JsonResult PerCutoffDate(string AttendanceID, string EmpID)
        {
            List<AbsencesAndTardiness> t = new List<AbsencesAndTardiness>();
            string conn = ConfigurationManager.ConnectionStrings["kalingaPPDO"].ConnectionString;
            using (SqlConnection cn = new SqlConnection(conn))
        ...
        // GET: AbsencesTardinessDetailsPerCutoffDate
        ...
        // GET: AbsencesTardinessDetailsPerCutoffDate/Details/5
        ...
        // GET: AbsencesTardinessDetailsPerCutoffDate/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AbsencesTardinessDetailsPerCutoffDate/Create
        ...
        // GET: AbsencesTardinessDetailsPerCutoffDate/Edit/5
        ...
        // POST: AbsencesTardinessDetailsPerCutoffDate/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AbsencesTardinessDetailsPerCutoffDate/Delete/5
        ...
        // POST: AbsencesTardinessDetailsPerCutoffDate/Delete/5
